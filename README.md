...
March 2025 tested on Bookworm 64 bit

Make a backup of your system before running this script

Auto Install Desktop to Raspberrypi OS Lite

You may be running Raspian Lite headless, on occasions it can be handy to access your Pi using a GUI via VNC and this
script will install a minimal version of the Desktop, VNC can be enabled using raspi-config from the terminal, also from the terminal enable Labwc window manager with Wayland backend.
